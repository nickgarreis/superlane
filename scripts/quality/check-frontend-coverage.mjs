...
const SUMMARY_PATH = path.join(ROOT, "security-reports", "coverage", "coverage-summary.json");
const THRESHOLDS_PATH = path.join(ROOT, "config", "quality", "frontend-coverage-thresholds.json");
...
const summary = readJson(
  SUMMARY_PATH,
  `Coverage summary not found: ${SUMMARY_PATH}. Run npm run test:frontend:coverage first.`,
);
...
console.log(`Frontend coverage gate (${activePhase})`);
