...
export const isAdminOrOwner = (role: Role): boolean => role === "admin" || role === "owner";
...
export const getWorkspaceGeneralDeniedReason = (role: Role): string | null =>
  isAdminOrOwner(role) ? null : "Only admins and owners can manage workspace settings";
...
export const getBrandAssetDeniedReason = (role: Role): string | null =>
  isAdminOrOwner(role) ? null : "Only admins and owners can manage brand assets";

export const getCommentAuthorDeniedReason = (isAuthor: boolean): string | null =>
  isAuthor ? null : "You can only edit, delete, or resolve your own comments";

export const getReviewCommentAuthorDeniedReason = (isAuthor: boolean): string | null =>
