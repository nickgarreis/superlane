...
} /** * ProjectLogo – renders the service icon for a project. * * @param size pixel dimensions (width & height) * @param category project category string; when matched, renders a raster * icon instead of the default Outlook-style SVG. */
export function ProjectLogo({
  ...
  return (
    ...
    >
      {" "}
      <div
        className="absolute inset-[6.97%_3.81%_10.13%_8.75%]"
        style={{
      ...
      >
        ...
        >
          ...
          <g>
            {" "}
            <path
              d={projectSvgPaths.p4533640}
              fill="url(#paint0_linear_1_566_sm)"
            />{" "}
            <path
              d={projectSvgPaths.p3fb64680}
              fill="url(#paint1_linear_1_566_sm)"
            />{" "}
            <path
              d={projectSvgPaths.p3fb64680}
              fill="url(#paint2_linear_1_566_sm)"
            />{" "}
            <path
              d={projectSvgPaths.p33e02200}
              fill="url(#paint3_linear_1_566_sm)"
            />{" "}
            <path
              d={projectSvgPaths.p33e02200}
              fill="url(#paint4_linear_1_566_sm)"
            />{" "}
            <path
              d={projectSvgPaths.p3b04b480}
              fill="url(#paint5_radial_1_566_sm)"
            />{" "}
            <path
              d={projectSvgPaths.p248f9400}
              fill="url(#paint6_linear_1_566_sm)"
            />{" "}
            <path
              d={projectSvgPaths.p248f9400}
              fill="url(#paint7_radial_1_566_sm)"
            />{" "}
            <path
              d={projectSvgPaths.p248f9400}
              fill="url(#paint8_radial_1_566_sm)"
            />{" "}
            <path
              d={projectSvgPaths.p2825c500}
              fill="url(#paint9_radial_1_566_sm)"
            />{" "}
            <path
              d={projectSvgPaths.p2825c500}
              fill="url(#paint10_linear_1_566_sm)"
            />{" "}
            <path
              d={projectSvgPaths.p219ad800}
              fill="url(#paint11_radial_1_566_sm)"
            />{" "}
            <path
              d={projectSvgPaths.p219ad800}
              fill="url(#paint12_radial_1_566_sm)"
            />{" "}
          ...
          <defs>
            ...
            <radialGradient
              cx="0"
              cy="0"
              gradientTransform="translate(64.3973 2.57269) rotate(-90) scale(87.0451 94.213)"
              gradientUnits="userSpaceOnUse"
              id="paint5_radial_1_566_sm"
              r="1"
            >
              {" "}
            ...
            <radialGradient
              cx="0"
              cy="0"
              gradientTransform="translate(77.5963 102.85) rotate(-45) scale(37.3032)"
              gradientUnits="userSpaceOnUse"
              id="paint7_radial_1_566_sm"
              r="1"
            >
              {" "}
            ...
            <radialGradient
              cx="0"
              cy="0"
              gradientTransform="translate(21.3298 130.37) rotate(-52.66) scale(126.627 114.503)"
              gradientUnits="userSpaceOnUse"
              id="paint8_radial_1_566_sm"
              r="1"
            >
              {" "}
            ...
            <radialGradient
              cx="0"
              cy="0"
              gradientTransform="translate(46.8973 69.4226) rotate(123.339) scale(66.8111 173.383)"
              gradientUnits="userSpaceOnUse"
              id="paint9_radial_1_566_sm"
              r="1"
            >
              {" "}
            ...
            <radialGradient
              cx="0"
              cy="0"
              gradientTransform="translate(-0.249215 56.7328) rotate(46.92) scale(67.8942 67.8942)"
              gradientUnits="userSpaceOnUse"
              id="paint11_radial_1_566_sm"
              r="1"
            >
              {" "}
            ...
            <radialGradient
              cx="0"
              cy="0"
              gradientTransform="translate(25.725 86.223) rotate(90) scale(36.104 41.6447)"
              gradientUnits="userSpaceOnUse"
              id="paint12_radial_1_566_sm"
              r="1"
            >
              {" "}
